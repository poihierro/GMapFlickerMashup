MapTutorial.Controllers.MapController = function(){
	...
	this.addNewActivity = function(photo){
		...
		infoBoxContentsHTML +=    '<img class="flickrImage" width="100" height="100" src="' + imageURL + '" />';
		infoBoxContentsHTML +=    '<div class="imageBorder imageBorderBottom"></div>';
		infoBoxContentsHTML +=    '<div class="photoInfoContainer"><ul>';
		infoBoxContentsHTML +=    '<li class="flickrPhotoTitle">Hotel Name:' + photo.title + '</li>'
		infoBoxContentsHTML +=    '<li class="flickrPhotoTitle">Number of Nights:' + photo.title + '</li>'
